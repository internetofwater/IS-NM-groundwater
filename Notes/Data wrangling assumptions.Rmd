...
#Make sure everything is in projection 4269
...
OSEWellID are not unique (there are 85 sites with an OSEWellID of 1) - for future reference, will need to convert to unique identifyer (or use OBJECTID) for gwl data in order for it to show up on the map
